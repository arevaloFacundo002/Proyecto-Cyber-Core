...
<head>
    ...
    <title>Crear Concepto-movimiento</title>
...
<div class="container">
    <div class="card card-form shadow">
        ...
        <div class="card-body p-4">
            <form 
            action="../../../controllers/tablasMaestrasControllers/ConceptoController.php?accion=crear"
            method="post">
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        name="descripcion"
                        class="form-control"
                        placeholder="Ingrese la descripcion del nuevo concepto del movimiento"
                        required>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="listarConcepto.php" class="btn btn-secondary">
                        ← Volver
                    </a>
