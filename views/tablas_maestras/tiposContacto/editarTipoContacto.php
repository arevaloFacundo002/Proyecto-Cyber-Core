...
<div class="container">
    <div class="card card-form shadow">
        ...
        <div class="card-body p-4">
            <form action="../../../controllers/tablasMaestrasControllers/TipoController.php?accion=editar" method="POST">
                <input
                    type="hidden"
                    name="id_tipo_contacto"
                    value="<?= $tipo['id_tipo_contacto'] ?>">
                ...
                <div class="d-flex justify-content-between">
                    <a
                        href="listarTipoContacto.php" class="btn btn-secondary">
                        ← Volver
                    </a>
