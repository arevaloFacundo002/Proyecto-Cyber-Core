...
<div class="container">
    <div class="card card-form shadow">
        <div class="card-header-custom">
            <h2>
                ✏️ Editar Metodo de Pago
            </h2>
        </div>

        <div class="card-body p-4">
            <form action="../../../controllers/tablasMaestrasControllers/MetodoController.php?accion=editar" 
            method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        name="descripcion"
                        class="form-control"
                        value="<?= htmlspecialchars($metodo['descripcion']) ?>"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="requiere_autorizacion" class="form-select">
                        <?php foreach($opciones_autorizacion as $valorBD => $textoVisual) { 
                            // Comparamos el valor numérico (1 o 0) con lo que viene de la base de datos
                            $selected = ($metodo['requiere_autorizacion'] == $valorBD) ? 'selected' : '';
                        ?>
                ...
                <div class="d-flex justify-content-between">
                    <a
                        href="listarMetodo.php" class="btn btn-secondary">
                        ← Volver
                    </a>
