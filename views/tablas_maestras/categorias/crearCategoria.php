...
foreach ($categorias as $c) {
    if ($c['rela_id_categoria_padre'] == null) {
        $categoriasPadre[] = $c;
    }
}
...
<div class="container">
    <div class="card card-form shadow">
        ...
        <div class="card-body p-4">
            <form 
            action="../../../controllers/tablasMaestrasControllers/CategoriaController.php?accion=crear"
            method="post">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text">
                        Si selecciona una categoría padre, se creará una subcategoría.
                    </div>
                </div>

                <div class="d-flex justify-content-between">
                    <a href="listarCategoria.php" class="btn btn-secondary">
                        ← Volver
                    </a>
